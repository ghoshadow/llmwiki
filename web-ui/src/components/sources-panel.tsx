                  ...
                  <tr key={src.meta.id} className="border-b last:border-b-0 hover:bg-accent/50">
                    ...
                    <td className="px-4 py-2">
                      <span className={`rounded px-2 py-0.5 text-xs ${
                        src.meta.status === 'ingested' ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-100' :
                        src.meta.status === 'error' ? 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-100' :
                        src.meta.status === 'processing' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-100' :
